...
import org.example.looam.book.outbound.repository.book.BookTagJpaRepository;
...
public class BaseApiTest {
  ...
  @Autowired BookTagJpaRepository bookTagJpaRepository;
  ...
  private void clearDB() {
    bookTagJpaRepository.deleteAll();
